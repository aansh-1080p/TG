          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Your registration form has been submitted successfully. Welcome to QuickHire!
              </p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Join QuickHire to find your dream job</CardDescription>
        </CardHeader>
        <CardContent>
